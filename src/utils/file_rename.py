...
def read_mapping_file(mapping_file: str, encoding: str) -> List[Dict[str, str]]:
    ...
    if missing_columns:
        raise ValueError(
            f"The mapping file is missing required columns: {missing_columns}. "
...
def main(
    ...
    try:
        ...
        successful, failed, errors = process_file_renaming(
            mappings, 
            input_dir_path, 
            output_dir_path
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--encoding", 
        type=str, 
        help="The encoding of the mapping file.", 
        default='utf-8'
    )
